                ...
                <table style="background-color:#f2f3f8;max-width:670px;margin:0 auto" width=100% border=0 align=center
                    ...
                    <tr>
                        <td style=text-align:center>
                            <img height=75 src="https://i.ibb.co/P9V9YKz/logo.png" alt=Sapo-logo border=0>
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <td style="padding:0 35px">
                                        <h1
                                            style="color:#1e1e2d;font-weight:500;margin:0;font-size:32px;font-family:'Rubik',sans-serif">
                                                You are request set up the password of your own</h1>
                                        <span
                                            style="display:inline-block;vertical-align:middle;margin:29px 0 26px;border-bottom:1px solid #cecece;width:100px"></span>
                                        <p style=color:#455056;font-size:15px;line-height:24px;margin:0>
                                            We can't just send you old passwords. A unique token to
                                            reset your password has been created for you.
                                            To re your password, you enter the code token under under to reset your password.
                                        </p>
                                        <h1
                    ...
                    <tr>
                        <td style=text-align:center>
                            <p style=font-size:14px;color:rgba(69,80,86,0.7411764705882353);line-height:18px;margin:0>
                                &copy; <strong>fpi.network</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style=height:80px>&nbsp;</td>
